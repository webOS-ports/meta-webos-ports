# imported from oe-core/pyro with following change backported from rocko
# to fix building linux-yocto-dev-4.19 against openssl-native from native
# RSS instead of trying to find openssl/bio.h on the host as in:
# http://jenkins.nas-admin.org/view/luneos-testing/job/luneos-testing_qemux86/549/consoleFull
#
# commit 37f20f2f7bdc8b964736c09371cd8f2342e4d5cb
# Author: Wenzong Fan <wenzong.fan@windriver.com>
# Date:   Wed Sep 20 01:17:05 2017 -0700
# Subject: kernel.bbclass: build host programs with native sysroots

...
Neither PN sets PREFERRED_VERSION, so bitbake takes the higher PV \
(pulseaudio-modules-droid-modern's 17.0.103+git) by default; a machine that \
genuinely needs this jb2q build (a real Android <=10 vendor, e.g. mako or \
hammerhead) must pin PREFERRED_VERSION_pulseaudio-modules-droid explicitly."

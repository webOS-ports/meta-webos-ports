...
S = "${UNPACKDIR}/${BB_GIT_DEFAULT_DESTSUFFIX}/messaging/signal/plugin/purple-presage"
...
do_install:append() {
    ...
    cp -rf ${UNPACKDIR}/${BB_GIT_DEFAULT_DESTSUFFIX}/messaging/signal/account/com.palm.signal ${D}${webos_accttemplatesdir}/

    # Validator app named by the template's validator.customUI.appId.
    install -d ${D}${webos_applicationsdir}
    cp -rf ${UNPACKDIR}/${BB_GIT_DEFAULT_DESTSUFFIX}/messaging/signal/apps/com.palm.app.signal ${D}${webos_applicationsdir}/
}

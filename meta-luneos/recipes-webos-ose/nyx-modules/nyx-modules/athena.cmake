...
# configuration file for athena (BlackBerry KEY2, SDM660)
#
# Deliberately identical to halium-arm64.cmake: athena is an ordinary arm64
# Treble device and has no reason to differ. Note in particular that there are
# no add_definitions() overrides for input or sysfs paths here, even though this
# device has an unusual input layout (an stmpe-keypad-bbry hardware QWERTY plus
# a touchscreen, and the keyboard doubles as a trackpad). Those paths belong to
# the runtime device-config service and /etc/nyx.conf, not to a build-time file
# - a device path compiled in here is a device we have not really ported.
# mindphone's copy of this file was a rosy copy-paste whose event nodes and
# battery paths were fiction; do not repeat that.

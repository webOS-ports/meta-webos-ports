...
# configuration file for surya (Xiaomi POCO X3 NFC, SM7150)
#
# Deliberately identical to halium-arm64.cmake: surya is an ordinary arm64
# Treble device and has no reason to differ. Note in particular that there are
# no add_definitions() overrides for input or sysfs paths here. Those paths
# belong to the runtime device-config service and /etc/nyx.conf, not to a
# build-time file - a device path compiled in here is a device we have not
# really ported. mindphone's copy of this file was a rosy copy-paste whose
# event nodes and battery paths were fiction; do not repeat that.

...
SRCREV = "32598dfc887c769b6e173cf346e19139d5353c98"
...
# Where nyx suspends through logind, systemd-sleep must not fall through to a
# lighter state when deep sleep aborts: that is a wakeup_count handshake abort
# and sleepd retries it. Single state; see the drop-in.
do_install:append() {

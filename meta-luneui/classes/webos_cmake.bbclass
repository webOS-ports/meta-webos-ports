...
EXTRA_OECMAKE_MACHINE = "${@ '-DWEBOS_TARGET_MACHINE:STRING=${MACHINE}' if d.getVar('PACKAGE_ARCH') == d.getVar('MACHINE_ARCH') and not bb.data.inherits_class('native', d) else '' }"
